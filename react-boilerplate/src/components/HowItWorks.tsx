...
export default function HowItWorks() {
  return (
    <section className="py-16 bg-gradient-to-b from-background to-secondary/10 bg-blue-900">
          ...
          {steps.map((step, index) => (
            <div key={index} className={`flex items-center mb-12 md:mb-2 relative ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
              <div className="w-full md:w-1/2 px-4">
                <div className=" p-6 rounded-lg hover:border-blue-400 shadow-lg border-primary border relative">
