...
export default function NavBar() {
  ...
  return (
    <div className="top-0 z-50 w-full">
      <div
        className={`slow bg-slate-600 flex items-center justify-between px-4 md:px-20 lg:px-32 py-2 w-full`}
      >
        <a href="/">
          <div
            className={`${
              show
                ? "absolute lg:relative z-50 w-full text-center lg:m-0 text-white lg:text-slate-500"
                : " text-slate-100"
            }`}
          >
        ...
        {/* <motion.ul className="hidden lg:flex w-3/6 justify-around">
          <a href="#"></a>
          <li className="slow hover:text-slate-800">
        ...
        {/* <AnimatePresence mode="popLayout">
          {show && (
            ...
            >
              <a href="#"></a>
              <li className="slow hover:text-slate-800 text-lg">
                <a className="slow hover:underline" href="#">
                  HOME
                </a>
              </li>
